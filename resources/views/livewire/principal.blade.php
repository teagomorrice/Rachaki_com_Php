    ...
    <main>
        ...
        <table id="tableClient" class="records">
            ...
            @foreach($partidas as $partida)
                ...
                <td>{{ $partida->hora }}</td>
                <td>
                <button type="button" class="button blue" onclick="location.href='{{ $partida->link }}';" target="_blank">Participar</button>
                <button type="submit" class="button green" wire:click="modalEdit({{ $partida }})">Editar</button>
                <button type="submit" class="button red" wire:click="modalDelete({{ $partida->id }})">Deletar</button>
                </td>
            @endforeach            
            </tbody>
        </table>
